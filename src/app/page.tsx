    ...
    <div className="flex flex-row bg-bgDeepGray">
      <div className="w-full h-lvh flex flex-col justify-center items-center">
        ...
        <div className="flex justify-center items-center space-x-4">
          <button
            className="bg-primaryGray text-white font-Pretendard text-[18px] hover:bg-customGreen active:bg-customGreen rounded-lg px-16 py-8 space-y-4"
          ...
          <button
            className="bg-[#242424] text-[#4F4F4F] font-Pretendard text-[18px] rounded-lg px-16 py-8 space-y-4"
            disabled
          >
            <Image
              src="student.svg"
        ...
        <p className="font-Pretendard font-normal text-center text-gray-500 mt-2">
          학생 서비스는 현재 준비중입니다 :)
          <br />
